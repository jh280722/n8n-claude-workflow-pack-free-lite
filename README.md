...
6. If you cloned the repo first, use `docs/clone-to-first-success.md` to validate locally, reach one safe public-repo run, and fill a clone-run public receipt before opening an issue. You can also run `python3 scripts/clone_run_receipt.py` to prefill the local validation part of that public-safe receipt before adding n8n/import results.
